...
<dl>
  <dt>Legitimacija</dt>
  <dd><input type="text" name="sudija[br_leg]" value="<?php echo h($sudija->br_leg) ?>" /></dd>
</dl>
...
<dl>
  <dt>Prebivalište</dt>
  <dd> <input type="text" name="sudija[prebivaliste]" value="<?php echo h($sudija->prebivaliste) ?>" /></dd>
</dl>

<dl>
  <dt>Opis</dt>
  <dd><textarea name="sudija[description]" rows="5" cols="50"><?php echo h($sudija->description) ?></textarea></dd>
</dl>
